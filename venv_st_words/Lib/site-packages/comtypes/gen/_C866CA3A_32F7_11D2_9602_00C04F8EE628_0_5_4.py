...
__all__ = [
    'SDKLLocalMachine', 'SRSActive', 'SDTProperty',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SVSkip',
    'DISPID_SPRFirstElement', 'SPCT_SUB_COMMAND', 'SPBO_TIME_UNITS',
    'SVP_17', 'SLTUser', 'ISpeechPhraseProperties',
    'DISPID_SRCCreateGrammar', 'SAFT44kHz8BitStereo',
    'SpeechGrammarTagWildcard', 'UINT_PTR', 'STSF_LocalAppData',
    'DISPID_SBSWrite', 'SP_VISEME_15', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SVEPhoneme',
    'SPPS_Unknown', 'SP_VISEME_21', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SpeechPhraseBuilder', 'SAFTADPCM_11kHzMono', 'SASPause',
    'SREHypothesis', 'DISPID_SRState', 'DISPID_SVDisplayUI',
    'SpeechAddRemoveWord', 'SAFT11kHz16BitStereo',
    'DISPID_SABIBufferSize', 'ISpMMSysAudio', 'SECHighConfidence',
    'SpeechTokenKeyUI', 'SPWORDPRONOUNCEABLE', 'ISpeechObjectToken',
    'SpeechEngineProperties', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SMSADeviceId', 'SpeechEngineConfidence',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechRecoResult',
    'SPSHT_NotOverriden', 'SVPNormal', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPEsItem', 'SpWaveFormatEx', 'ISpeechPhraseAlternates',
    'DISPID_SWFEBlockAlign', 'SREAllEvents',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRGetPropertyNumber',
    'eLEXTYPE_APP', 'IInternetSecurityManager', 'DISPID_SPRulesCount',
    'DISPID_SPPFirstElement', 'DISPID_SASNonBlockingIO',
    'SSTTTextBuffer', 'SPPS_Verb', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpeechEmulationCompareFlags', 'DISPID_SpeechGrammarRules',
    'DISPID_SLWWord', 'DISPID_SRSAudioStatus',
    'ISpeechRecognizerStatus', 'SPAR_High',
    'DISPID_SPIGetDisplayAttributes', 'SPVPRI_ALERT',
    'DISPID_SRGSetWordSequenceData', 'SpeechCategoryPhoneConverters',
    'SVP_2', 'SPXMLRESULTOPTIONS', 'DISPID_SRCCreateResultFromMemory',
    'SpeechRegistryLocalMachineRoot', 'SREBookmark', 'DISPID_SPPId',
    'SGSExclusive', 'SPDATAKEYLOCATION', 'DISPID_SRCEEnginePrivate',
    'SP_VISEME_9', 'SDA_Consume_Leading_Spaces', 'SRERecognition',
    'SGRSTTWildcard', 'DISPID_SRRTStreamTime', 'SVSFIsNotXML',
    'SAFT16kHz16BitStereo', 'ISpeechVoice', 'SDTReplacement',
    'DISPIDSPRG', 'SPEI_END_SR_STREAM', 'ISpRecoContext2',
    'SWPKnownWordPronounceable', 'SECFNoSpecialChars',
    'DISPID_SpeechRecoContext', 'SAFTCCITT_ALaw_44kHzStereo',
    'eLEXTYPE_PRIVATE1', 'SPAS_RUN', 'SPSFunction', 'STCLocalServer',
    'SWTDeleted', 'SpSharedRecognizer', 'DISPID_SVAudioOutput',
    'DISPID_SPEAudioTimeOffset', 'SVEWordBoundary', 'SVSFUnusedFlags',
    'SpeechInterference', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpEventSource', 'DISPID_SAEventHandle', 'SAFT11kHz8BitMono',
    'DISPID_SRSCurrentStreamPosition', 'SPSHORTCUTTYPE',
    'SPVOICESTATUS', 'SAFT22kHz16BitStereo', 'DISPID_SRCState',
    'DISPID_SVPause', 'DISPID_SRCreateRecoContext',
    'DISPID_SGRSTType', 'DISPID_SRIsUISupported', 'SVP_0',
    'SVSFPurgeBeforeSpeak', 'DISPID_SGRSRule', 'SPEI_MAX_SR',
    'SREPrivate', 'SPWORD', 'SPEI_SOUND_END', 'SGPronounciation',
    'SpeechRetainedAudioOptions', 'SPAUDIOBUFFERINFO',
    'Speech_StreamPos_RealTime', 'DISPID_SOTCreateInstance',
    'SPEI_VISEME', 'SpeechPropertyNormalConfidenceThreshold',
    'SRSEDone', 'DISPID_SVSpeak', 'SPAR_Medium', 'SpShortcut',
    'SPAO_RETAIN_AUDIO', 'SREInterference', 'ISpRecoContext',
    'ISpeechMemoryStream', 'SPAUDIOOPTIONS', 'SPLEXICONTYPE',
    'DISPID_SFSClose', 'ISpeechGrammarRules', 'DISPID_SPCIdToPhone',
    'ISpVoice', 'eLEXTYPE_PRIVATE16', 'ISpNotifySource',
    'DISPID_SpeechPhraseElements', 'SGRSTTEpsilon',
    'DISPID_SRSetPropertyString', 'SpeechRuleAttributes',
    'DISPID_SLPLangId', 'DISPID_SRCERecognizerStateChange',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechPropertyComplexResponseSpeed', 'ISpEventSink',
    'eLEXTYPE_PRIVATE11', 'eLEXTYPE_PRIVATE14',
    'SPEI_SR_RETAINEDAUDIO', 'SRADefaultToActive', 'DISPID_SPRText',
    'DISPID_SPELexicalForm', 'DISPID_SPRsCount', '_SPAUDIOSTATE',
    'DISPID_SpeechCustomStream', 'eLEXTYPE_RESERVED4',
    'DISPID_SPEActualConfidence', 'DISPID_SPRNumberOfElements',
    'SAFT16kHz8BitStereo', 'DISPID_SPEPronunciation', 'SPSLMA',
    'DISPID_SVSInputSentenceLength', 'DISPID_SLWsItem',
    'DISPID_SPRuleParent', 'ISpPhrase', 'SPPHRASEPROPERTY',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SpeechWaveFormatEx',
    'SpNotifyTranslator', 'SINone', 'DISPID_SAFGuid',
    'SRSInactiveWithPurge', 'DISPID_SRCEAdaptation',
    'SSFMCreateForWrite', 'SLOStatic', 'DISPID_SOTRemove',
    'SpeechGrammarState', 'DISPID_SREmulateRecognition',
    'ISpPhoneConverter', 'ISpAudio', 'SRTStandard', 'DISPID_SBSSeek',
    'DISPID_SPIAudioStreamPosition', 'SVEAudioLevel',
    'eLEXTYPE_RESERVED9', 'SAFTADPCM_8kHzMono', 'ISpeechAudio',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVEStreamStart',
    'SpeechCategoryAppLexicons', 'SP_VISEME_13', 'SRAONone',
    'SFTSREngine', 'SPSNotOverriden', 'ISpeechAudioStatus',
    'SVEVoiceChange', 'SAFT32kHz16BitMono',
    'SpeechRecoProfileProperties', 'SPAS_STOP',
    'DISPID_SWFEExtraData', 'SAFT11kHz16BitMono',
    'SPFM_OPEN_READONLY', 'SPINTERFERENCE_TOOSLOW', 'SP_VISEME_10',
    'DISPID_SPRulesItem', 'SVP_15', 'DISPID_SpeechPhraseElement',
    'DISPID_SGRSTPropertyName', 'ISpLexicon', 'SAFTGSM610_8kHzMono',
    'ISpGrammarBuilder', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SpeechVoice', 'DISPID_SPIProperties',
    'ISpeechTextSelectionInformation', 'SPEI_RESERVED2',
    'DISPID_SpeechRecognizer', 'SPEI_START_SR_STREAM',
    'eLEXTYPE_RESERVED7', 'DISPIDSPTSI_SelectionLength',
    'SVEBookmark', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SGRSTWeight', 'DISPID_SLAddPronunciation',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechLexiconPronunciation',
    'DISPID_SDKSetStringValue', 'DISPID_SRGIsPronounceable',
    'SPSHT_OTHER', 'SPSHORTCUTPAIRLIST', 'SPAUDIOSTATE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SBSRead',
    'SPAO_NONE', 'SDKLCurrentConfig', 'SAFT11kHz8BitStereo',
    'DISPID_SPRs_NewEnum', 'DISPID_SOTGetDescription', 'SREStreamEnd',
    'DISPID_SPEAudioSizeBytes', 'ISpeechRecoResultTimes',
    'SPEI_UNDEFINED', 'SpeechRegistryUserRoot', 'SVF_None',
    'DISPID_SRCERecognition', 'DISPID_SGRSTsItem', 'SP_VISEME_0',
    'SpPhraseInfoBuilder', 'ISpResourceManager',
    'SAFTGSM610_11kHzMono', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVEVoiceChange', 'SpInprocRecognizer',
    'SPINTERFERENCE_NOISE', 'ISpeechFileStream',
    'SPXRO_Alternates_SML', 'DISPID_SVPriority', 'DISPID_SPIEngineId',
    'SP_VISEME_2', 'SpObjectTokenCategory', 'SRADynamic',
    'ISpRecoCategory', 'DISPID_SRCCmdMaxAlternates', 'SPINTERFERENCE',
    'DISPID_SPERetainedStreamOffset', 'SPEI_FALSE_RECOGNITION',
    'SGLexicalNoSpecialChars', 'ISpeechPhraseElement', 'SGDisplay',
    'DISPID_SRCRecognizer', 'DISPID_SRCEPhraseStart',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_MIN_TTS', 'SVP_5',
    'DISPID_SLPType', 'SRSInactive', 'SVP_4', 'DISPID_SRCESoundStart',
    'SPEI_RECOGNITION', 'DISPID_SDKDeleteKey',
    'DISPID_SVSLastBookmark', 'DISPID_SWFEBitsPerSample',
    'SVEEndInputStream', 'SVP_16', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPPParent', 'SAFT12kHz8BitMono', 'SPVPRI_OVER',
    'SpeechPropertyResourceUsage', 'DISPID_SOTCDefault',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVP_18', 'SpeechCategoryAudioOut',
    'DISPID_SMSGetData', 'SASRun', 'DISPID_SVVolume',
    'DISPID_SWFESamplesPerSec', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SASFreeBufferSpace', 'SpCustomStream',
    'DISPID_SDKSetBinaryValue', 'DISPID_SABIEventBias',
    'DISPID_SpeechObjectTokens', 'SpeechLoadOption',
    'ISpeechGrammarRule', 'SRSActiveAlways', 'SPDKL_CurrentUser',
    'DISPID_SRCVoice', 'SASStop', 'DISPID_SRSNumberOfActiveRules',
    'SLODynamic', 'SPPROPERTYINFO', 'SpeechTokenShellFolder',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVSyncronousSpeakTimeout',
    'STSF_AppData', 'IEnumString', 'SVSFlagsAsync',
    'DISPID_SRCRetainedAudio', 'SDA_Two_Trailing_Spaces',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechMMSysAudio',
    'SVSFPersistXML', 'DISPID_SLGetPronunciations',
    'SpStreamFormatConverter', 'SAFT24kHz16BitMono', 'SVSFParseSapi',
    'DISPID_SRGRecoContext', 'DISPID_SOTCategory', 'SPEI_SR_PRIVATE',
    'SVP_21', 'SECLowConfidence', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPRuleId', 'SSFMOpenForRead', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpeechMMSysAudio', 'SPEI_RESERVED3', 'SVP_19', 'SVP_7',
    'Speech_Default_Weight', 'DISPIDSPTSI_ActiveLength',
    'SAFTNoAssignedFormat', 'SpeechGrammarRuleStateTransitionType',
    'SPPS_RESERVED3', 'DISPID_SRGCmdLoadFromFile', 'SRTSMLTimeout',
    'ISpeechPhraseProperty', 'SPADAPTATIONRELEVANCE',
    'DISPID_SPAsCount', 'SDTRule', 'SSFMCreate', 'SVSFNLPSpeakPunc',
    'SPEI_TTS_BOOKMARK', 'DISPID_SVSInputSentencePosition',
    'eWORDTYPE_ADDED', 'DISPID_SLPs_NewEnum',
    'DISPID_SGRSAddWordTransition', 'SREPhraseStart',
    'SAFTNonStandardFormat', 'DISPID_SRRAlternates',
    'SGRSTTTextBuffer', 'SPRECOSTATE', 'DISPID_SRRTOffsetFromStart',
    'ISpStreamFormatConverter', 'SINoise', 'ISpeechRecoResult2',
    'SAFT16kHz8BitMono', 'ISpDataKey', 'SPLO_DYNAMIC',
    'DISPID_SRGState', 'DISPID_SpeechAudioFormat', 'ISpPhraseAlt',
    'DISPID_SPIAudioSizeTime', 'tagSTATSTG', 'DISPID_SDKEnumKeys',
    'DISPID_SGRInitialState', 'SAFT32kHz8BitStereo',
    'SPPHRASEREPLACEMENT', 'SVPAlert', 'eLEXTYPE_USER',
    'SpeechRecognitionType', 'SFTInput', 'SpResourceManager',
    'DISPID_SVVoice', 'DISPID_SPACommit', 'SPSMF_UPS', 'SPLO_STATIC',
    'SAFT24kHz8BitMono', 'SITooSlow', 'SGDSActive', 'SP_VISEME_3',
    'DISPID_SRGetRecognizers', 'SpVoice', 'SPPARTOFSPEECH',
    'DISPID_SGRSTText', 'DISPID_SVEBookmark', 'SAFTADPCM_22kHzStereo',
    'SRERequestUI', 'DISPID_SPPChildren', 'SVSFDefault',
    'DISPID_SCSBaseStream', 'SPBO_PAUSE', 'ISpRecoGrammar2',
    'SpeechRecognizerState', 'SpeechCategoryRecoProfiles',
    'DISPID_SRRAudio', 'SpeechWordPronounceable',
    'SpeechAudioProperties', 'ISpSerializeState',
    'DISPID_SVSLastResult', 'DISPID_SRGetFormat', 'SPEI_TTS_PRIVATE',
    'SPRS_ACTIVE_USER_DELIMITED', 'SP_VISEME_11', 'SGSEnabled',
    'DISPID_SABufferNotifySize', 'SVP_6',
    'DISPID_SPRDisplayAttributes',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPWT_PRONUNCIATION',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRCESoundEnd',
    'DISPID_SRRTimes', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SPEs_NewEnum', 'DISPID_SRProfile', 'DISPID_SGRsAdd',
    'SP_VISEME_8', 'DISPID_SPAs_NewEnum', 'SITooLoud',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRCPause',
    'DISPID_SDKCreateKey', 'SREAdaptation',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPIElements',
    'SpMMAudioOut', 'SpeechPropertyAdaptationOn', 'ISpRecoResult',
    'eLEXTYPE_PRIVATE4', 'DISPID_SAFType', 'ISpeechLexiconWord',
    'DISPID_SLWLangId', 'SAFT44kHz16BitStereo', 'DISPID_SPPsCount',
    'DISPID_SRRSetTextFeedback', 'DISPID_SGRSTsCount', 'SPFM_CREATE',
    'SpeechVoiceCategoryTTSRate', 'SGDSInactive', 'SPEI_SR_BOOKMARK',
    'SPPS_Interjection', 'SREAudioLevel', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRGId', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechPhoneConverter', 'SPEI_SENTENCE_BOUNDARY',
    'STSF_FlagCreate', 'SPTEXTSELECTIONINFO', 'DISPID_SOTsItem',
    'DISPID_SOTDisplayUI', 'SpPhoneConverter', 'SPSERIALIZEDRESULT',
    'SpeechDataKeyLocation', 'SP_VISEME_14', 'SpeechRecoContextState',
    'DISPID_SPPBRestorePhraseFromMemory', 'SSSPTRelativeToStart',
    'SpeechPartOfSpeech', 'DISPID_SLPPartOfSpeech', 'ISpObjectToken',
    'SpInProcRecoContext', 'SPPS_RESERVED1', 'ISpRecognizer3',
    'SpeechTokenIdUserLexicon', 'ISpRecoGrammar',
    'DISPID_SPIGrammarId', 'DISPID_SPRuleFirstElement',
    'SAFTExtendedAudioFormat', 'SPAS_PAUSE',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SOTIsUISupported', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRCResume', 'DISPID_SPAPhraseInfo',
    'DISPID_SOTGetAttribute', 'eLEXTYPE_RESERVED10', 'SPPS_Noun',
    'SECFIgnoreWidth', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPIStartTime', 'DISPID_SFSOpen',
    'DISPID_SRGSetTextSelection', 'SAFT16kHz16BitMono', 'SPVISEMES',
    'SPCT_COMMAND', 'DISPID_SPRuleName', 'SPINTERFERENCE_TOOLOUD',
    'SPGRAMMARWORDTYPE', 'ISpeechRecoGrammar', 'SWTAdded',
    'SpNullPhoneConverter', 'SP_VISEME_16', 'SPEVENTENUM',
    'SVEAllEvents', 'SPWORDTYPE', 'SAFT8kHz16BitMono', 'SP_VISEME_20',
    'SAFT12kHz16BitStereo', 'DISPID_SDKEnumValues', 'SPCT_DICTATION',
    'SPDKL_CurrentConfig', 'ISpeechDataKey', 'SPPHRASERULE',
    'SAFT48kHz16BitStereo', 'DISPID_SRRRecoContext', 'SRCS_Disabled',
    'SpeechCategoryRecognizers', 'SPPS_SuppressWord',
    'DISPID_SpeechFileStream', 'SpeechCategoryAudioIn', 'SVP_20',
    'SAFT48kHz8BitStereo', 'SPRST_INACTIVE_WITH_PURGE',
    'SPAUDIOSTATUS', 'SPSMF_SRGS_SAPIPROPERTIES', 'SAFT44kHz8BitMono',
    'DISPID_SGRAttributes', 'SECNormalConfidence',
    'SpeechSpecialTransitionType', 'SVP_10',
    'DISPID_SRCERecognitionForOtherContext', 'ISpeechRecoContext',
    'SAFT8kHz8BitStereo', 'DISPID_SpeechPhraseReplacements',
    'SPRECOCONTEXTSTATUS', 'SPCS_DISABLED',
    'DISPID_SpeechPhraseProperties', 'SBOPause', 'SPVPRI_NORMAL',
    'SPEI_HYPOTHESIS', 'DISPID_SRGCommit', 'DISPID_SpeechVoiceStatus',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SBSFormat',
    'DISPID_SOTCSetId', 'ISpeechGrammarRuleStateTransition',
    'WAVEFORMATEX', 'DISPID_SVSCurrentStreamNumber', 'ISpRecognizer2',
    'SPRS_ACTIVE', 'DISPID_SWFEFormatTag',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRStatus',
    'ISpeechLexicon', 'SPFM_OPEN_READWRITE', 'SLTApp',
    'DISPID_SVGetAudioOutputs',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechPropertyResponseSpeed', '__MIDL_IWinTypes_0009',
    'SRERecoOtherContext', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPRULESTATE',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SLWs_NewEnum', 'SPINTERFERENCE_NONE', 'eLEXTYPE_PRIVATE2',
    'SVF_Stressed', '_ISpeechVoiceEvents', 'SPWT_LEXICAL',
    'DISPID_SRSCurrentStreamNumber',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRCERequestUI',
    'SDTAll', 'DISPID_SABufferInfo', 'SPSHT_EMAIL',
    'DISPID_SVGetVoices', 'ISpeechPhraseRule', 'SAFT8kHz8BitMono',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechRuleState',
    'SPPS_Function', 'SSTTWildcard', 'DISPID_SGRsItem',
    'SAFTGSM610_22kHzMono', 'ISpPhoneticAlphabetSelection',
    'DISPID_SpeechLexiconWord', 'DISPID_SASState', 'SPXRO_SML',
    'SpAudioFormat', 'DISPID_SRCEventInterests', 'SPEI_PHRASE_START',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRCEFalseRecognition',
    'SRTExtendableParse', 'SPSERIALIZEDPHRASE', 'SVPOver',
    'SpeechRunState', 'DISPID_SGRSTPropertyValue',
    'ISpeechCustomStream', 'DISPID_SOTSetId', 'ISpXMLRecoResult',
    'SAFT22kHz8BitStereo', 'SPPS_RESERVED4', 'DISPID_SGRSTPropertyId',
    'SpeechDictationTopicSpelling', 'SITooQuiet', 'DISPID_SAVolume',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPRuleChildren',
    'SPCATEGORYTYPE', 'DISPID_SRSSupportedLanguages',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPAStartElementInResult',
    'SAFTCCITT_uLaw_44kHzMono', '_ISpeechRecoContextEvents',
    'DISPID_SpeechPhraseRules', 'SPEI_VOICE_CHANGE', 'SPAR_Low',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_WORD_BOUNDARY', 'SPEI_MIN_SR', 'SpeechVisemeFeature',
    'DISPID_SVEEnginePrivate', 'eWORDTYPE_DELETED', 'DISPID_SPRsItem',
    'DISPID_SpeechGrammarRule', 'SSSPTRelativeToCurrentPosition',
    'SWPUnknownWordPronounceable', 'DISPID_SPEAudioStreamOffset',
    'SVP_14', 'DISPID_SRRTLength', 'ISpProperties', 'SPWORDLIST',
    'eLEXTYPE_PRIVATE3', 'SPAS_CLOSED', 'SpObjectToken',
    'DISPID_SGRSTNextState', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SDKOpenKey',
    'SAFTADPCM_44kHzMono', 'SPPS_NotOverriden',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRDisplayUI', 'SPEI_REQUEST_UI',
    'DISPID_SPCPhoneToId', 'SAFTGSM610_44kHzMono',
    'eLEXTYPE_PRIVATE5', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRCEInterference', 'DISPID_SVSpeakStream',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVEViseme',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPEVENT',
    'DISPID_SPPsItem', 'DISPID_SpeechObjectToken', 'SPBINARYGRAMMAR',
    'SPWT_DISPLAY', 'SGSDisabled', 'SVSFParseAutodetect',
    'SDTLexicalForm', 'SPRS_INACTIVE', 'tagSPPROPERTYINFO',
    'DISPID_SAStatus', 'DISPID_SOTDataKey', 'DISPID_SWFEChannels',
    'SPSHT_Unknown', 'SRESoundStart', 'ISpeechRecoResultDispatch',
    'eLEXTYPE_PRIVATE20', 'SPGS_EXCLUSIVE', 'DISPID_SVEventInterests',
    'SpeechGrammarTagDictation', 'SRAORetainAudio',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SVP_3', 'DISPID_SLPSymbolic',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRRPhraseInfo',
    'DISPID_SDKGetBinaryValue', 'SpeechVoiceEvents', 'LONG_PTR',
    'ISpeechAudioBufferInfo', 'SpeechRecoEvents',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPISaveToMemory',
    'DISPID_SPPEngineConfidence', 'DISPID_SOTMatchesAttributes',
    'SPEI_ADAPTATION', 'DISPID_SpeechRecognizerStatus',
    'SPWAVEFORMATTYPE', 'STCAll', 'SBONone',
    'DISPID_SGRsCommitAndSave', 'DISPID_SVEWord',
    'Speech_Max_Word_Length', 'SVEPrivate', 'DISPID_SDKDeleteValue',
    'SPDKL_LocalMachine', 'SPPHRASE', 'DISPID_SGRId',
    'ISpeechObjectTokens', 'ISpeechGrammarRuleState',
    'SDKLDefaultLocation', 'SAFTADPCM_44kHzStereo', 'DISPID_SOTId',
    'SPGS_ENABLED', 'ISpeechVoiceStatus', 'STCRemoteServer',
    'SPRST_ACTIVE_ALWAYS', 'SPLOADOPTIONS', 'ISpeechPhraseElements',
    'SVF_Emphasis', 'DISPID_SPPNumberOfElements', 'SASClosed',
    'DISPID_SOTGetStorageFileName', 'DISPID_SGRSTransitions',
    'DISPID_SRRSaveToMemory', 'SP_VISEME_5', 'SPRST_NUM_STATES',
    'SpeechAudioState', 'DISPID_SGRSTRule', 'SGDSActiveUserDelimited',
    'SVESentenceBoundary', 'DISPID_SVResume', 'SPPHRASEELEMENT',
    'DISPID_SVSInputWordLength', 'SDA_No_Trailing_Space',
    'SPAR_Unknown', 'SpeechVoicePriority', 'SECFIgnoreCase',
    'DISPIDSPTSI', 'ISpeechPhraseInfo', 'SAFT48kHz8BitMono',
    'DISPID_SPPs_NewEnum', 'DISPID_SRGCmdLoadFromObject',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRRTTickCount',
    'DISPID_SGRAddState', 'SpLexicon', 'DISPID_SOTCEnumerateTokens',
    'eLEXTYPE_RESERVED6', 'SPEI_PHONEME', 'IInternetSecurityMgrSite',
    'SVP_8', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRSetPropertyNumber', 'SGRSTTWord', 'ISpNotifyTranslator',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SLWsCount',
    'ISpObjectTokenCategory', 'DISPID_SADefaultFormat',
    'DISPID_SMSAMMHandle', 'SpeechAudioFormatGUIDText',
    'DISPID_SVGetProfiles', 'SREStreamStart', 'DISPID_SOTCId',
    'eLEXTYPE_PRIVATE9', 'ISpeechObjectTokenCategory',
    'SPSInterjection', 'SpTextSelectionInformation',
    'SDA_One_Trailing_Space', 'ISpeechAudioFormat', 'SPWF_SRENGINE',
    'SpMMAudioIn', 'DISPID_SVStatus', 'SRTEmulated',
    'SpeechGrammarTagUnlimitedDictation', 'SDTAlternates',
    'DISPID_SRGRules', 'SVEPhoneme', 'SP_VISEME_19',
    'SPEI_PROPERTY_STRING_CHANGE', 'STSF_CommonAppData',
    'ISpeechXMLRecoResult', 'SVSFParseMask',
    'DISPID_SPEAudioSizeTime', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPRST_INACTIVE', 'DISPID_SRCEEndStream', 'eLEXTYPE_PRIVATE13',
    'SpMemoryStream', 'SpeechDiscardType', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechLexiconWords', 'ISequentialStream',
    'DISPIDSPTSI_SelectionOffset', 'SAFTDefault',
    'ISpeechWaveFormatEx', 'SPCT_SUB_DICTATION',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SVAudioOutputStream',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPEDisplayAttributes',
    'SP_VISEME_7', 'SpeechTokenContext', 'SpeechAudioFormatType',
    'SRSEIsSpeaking', 'SpCompressedLexicon',
    'SpeechStreamSeekPositionType', 'DISPID_SVIsUISupported',
    'ISpeechResourceLoader', 'SVP_12', 'DISPID_SRGDictationUnload',
    'DISPID_SPILanguageId', 'eLEXTYPE_VENDORLEXICON', 'SVSFNLPMask',
    'ISpStream', 'SRTReSent', 'SPFM_NUM_MODES', 'SPPS_LMA',
    'DISPID_SGRsDynamic', 'SPVPRIORITY', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRIsShared', 'DISPID_SPPConfidence',
    'DISPID_SOTCGetDataKey', 'SpPhoneticAlphabetConverter',
    'SPPS_Noncontent', 'DISPID_SpeechLexiconProns', 'DISPID_SRGReset',
    'SAFT12kHz16BitMono', 'SpeechLexiconType', 'eLEXTYPE_PRIVATE8',
    'eLEXTYPE_PRIVATE6', 'SPEI_RECO_STATE_CHANGE', 'SP_VISEME_4',
    'DISPID_SPAsItem', 'ISpeechRecognizer', 'DISPID_SPIRule',
    'SPEI_RESERVED1', 'DISPID_SVSRunningState', 'SAFT44kHz16BitMono',
    'DISPID_SpeechRecoResult2', 'DISPID_SRAudioInputStream',
    'SPFILEMODE', 'DISPID_SVEStreamEnd', 'eLEXTYPE_PRIVATE10',
    'DISPID_SVSInputWordPosition', 'IStream', 'SpStream',
    'SPPS_RESERVED2', 'DISPID_SRRecognizer', 'STCInprocServer',
    'DISPID_SGRClear', 'DISPID_SRRAudioFormat',
    'SGDSActiveWithAutoPause', 'DISPID_SVESentenceBoundary',
    'SGRSTTDictation', 'eLEXTYPE_PRIVATE17',
    'ISpeechPhraseReplacement', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_SOUND_START', 'DISPID_SLGenerationId',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SGRs_NewEnum',
    'DISPID_SRGDictationLoad', 'SpeechFormatType',
    'DISPID_SpeechDataKey', 'Speech_Max_Pron_Length',
    'SECFEmulateResult', 'DISPID_SDKGetlongValue', 'SVSFParseSsml',
    'ISpObjectWithToken', 'DISPID_SPCLangId', 'SAFTADPCM_11kHzStereo',
    'SPBOOKMARKOPTIONS', 'SVSFVoiceMask', 'SPCS_ENABLED',
    'SAFTADPCM_22kHzMono', 'SPEI_RESERVED5',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechStreamFileMode',
    'DISPID_SPRuleEngineConfidence', 'SPSEMANTICERRORINFO',
    'DISPID_SpeechPhraseRule', 'ISpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE18', 'SVP_13', 'SSTTDictation',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SGRsCount',
    'SGLexical', 'DISPID_SPIEnginePrivateData',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpNotifySink', 'SPGRAMMARSTATE',
    'SpeechMicTraining', 'ISpeechLexiconWords', 'SVEStartInputStream',
    'DISPID_SGRAddResource', 'DISPID_SRCEHypothesis', 'SpFileStream',
    'DISPID_SDKSetLongValue', 'SDTPronunciation',
    'SpeechTokenKeyFiles', 'SpeechAllElements', 'SRAImport',
    'SRARoot', 'DISPID_SRSClsidEngine', 'DISPID_SLPsCount',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPRuleConfidence',
    'SREFalseRecognition', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpeechLexiconPronunciations', 'DISPID_SVSVisemeId',
    'ISpShortcut', 'SPGS_DISABLED', 'DISPID_SVEViseme',
    'SpeechVisemeType', 'DISPID_SPANumberOfElementsInResult',
    'SDTAudio', 'DISPID_SpeechRecoResultTimes', 'SP_VISEME_6',
    'DISPID_SGRName', 'SPEI_INTERFERENCE', 'DISPID_SRRGetXMLResult',
    'SPCONTEXTSTATE', 'DISPID_SpeechAudio',
    'DISPID_SRCEPropertyStringChange', 'ISpeechRecoResult',
    'DISPID_SRCEAudioLevel', 'SPBO_NONE', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SpeechAudioStatus', 'DISPID_SPIReplacements',
    'DISPID_SRCEBookmark', 'SPWORDPRONUNCIATION',
    'SAFT8kHz16BitStereo', 'DISPID_SRRGetXMLErrorInfo',
    'SPRECOGNIZERSTATUS', 'DISPID_SLGetWords', 'ISpStreamFormat',
    'DISPID_SVGetAudioInputs', 'SRATopLevel', 'SpeechUserTraining',
    'DISPID_SLGetGenerationChange', 'SVSFIsFilename', 'SPEI_MAX_TTS',
    'SPSUnknown', 'tagSPTEXTSELECTIONINFO', 'SRAInterpreter',
    'SpMMAudioEnum', 'SPINTERFERENCE_TOOQUIET',
    'SpeechGrammarWordType', 'SSFMOpenReadWrite',
    'DISPID_SLWPronunciations', 'SPSEMANTICFORMAT',
    'SpUnCompressedLexicon', 'DISPID_SPERequiredConfidence',
    'SPBO_AHEAD', 'DISPID_SpeechPhraseProperty',
    'DISPID_SGRSAddRuleTransition', 'SREPropertyNumChange',
    'SPRECORESULTTIMES', 'SWPUnknownWordUnpronounceable',
    'SP_VISEME_1', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechVoiceSpeakFlags', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SGRSTs_NewEnum', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SMSALineId', 'SRESoundEnd', 'SpSharedRecoContext',
    'SAFT24kHz8BitStereo', 'SPWORDPRONUNCIATIONLIST',
    'SpeechDisplayAttributes', '_RemotableHandle',
    'SpeechAudioVolume', 'DISPID_SPEDisplayText',
    'SpeechTokenValueCLSID', 'DISPID_SASetState',
    'DISPID_SLPPhoneIds', 'SPPS_Modifier',
    'DISPID_SVSLastStreamNumberQueued', 'IEnumSpObjectTokens',
    'SRTAutopause', 'DISPID_SABIMinNotification', 'SPRULE',
    'SP_VISEME_18', 'DISPID_SLWType', 'SP_VISEME_12',
    'DISPID_SWFEAvgBytesPerSec', 'SECFDefault', 'DISPID_SPIGetText',
    'DISPID_SRGDictationSetState', 'SP_VISEME_17',
    'SECFIgnoreKanaType', 'SPSSuppressWord', 'ISpeechBaseStream',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SOTsCount', 'SITooFast',
    'DISPID_SRCRequestedUIType', 'DISPID_SLRemovePronunciation',
    'DISPID_SPARecoResult', 'DISPID_SPRules_NewEnum', 'SPRST_ACTIVE',
    'DISPID_SASCurrentSeekPosition', 'SpeechBookmarkOptions',
    'DISPID_SRCEPropertyNumberChange', 'SREPropertyStringChange',
    'SREStateChange', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCEStartStream', 'DISPID_SRRSpeakAudio',
    'Speech_StreamPos_Asap', 'DISPID_SPEEngineConfidence',
    'SAFT24kHz16BitStereo', 'ISpRecognizer', 'eLEXTYPE_PRIVATE12',
    'SVP_11', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRGetPropertyString', 'ISpeechPhoneConverter', 'SPSVerb',
    'SPEVENTSOURCEINFO', 'eLEXTYPE_RESERVED8', 'DISPID_SPEsCount',
    'SPSModifier', 'DISPID_SpeechMemoryStream', 'SPWF_INPUT',
    'SPSHORTCUTPAIR', 'SPCT_SLEEP', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPDKL_DefaultLocation',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SMSSetData', 'DISPID_SPPValue', 'DISPID_SVRate',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFT22kHz8BitMono',
    'eLEXTYPE_PRIVATE15', 'eLEXTYPE_USER_SHORTCUT', 'SRAExport',
    'DISPID_SOTs_NewEnum', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechBaseStream', 'SINoSignal', 'DISPID_SPPName',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechPhraseRules',
    'SDKLCurrentUser', 'DISPID_SLPsItem', 'DISPID_SGRsFindRule',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SpeechVoiceEvent',
    'SRCS_Enabled', 'DISPID_SGRsCommit', 'SVP_1', 'SPSNoun',
    'DISPID_SVEAudioLevel', 'SVP_9', 'DISPID_SDKGetStringValue',
    'SGRSTTRule', 'DISPID_SVWaitUntilDone', 'DISPID_SRAudioInput',
    'DISPID_SpeechRecoContextEvents', 'SAFTCCITT_uLaw_11kHzMono',
    'SVSFIsXML', 'SAFT22kHz16BitMono', 'SpeechCategoryVoices',
    'SpeechTokenKeyAttributes', 'DISPID_SpeechLexicon',
    'SDTDisplayText', 'SAFTText', 'SPEI_RESERVED6',
    'STCInprocHandler', 'ISpeechPhraseReplacements',
    'DISPID_SRCBookmark', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechXMLRecoResult', 'SpeechWordType',
    'SAFT32kHz8BitMono', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SSSPTRelativeToEnd',
    'SPSMF_SAPI_PROPERTIES', 'SAFT48kHz16BitMono'
]

_check_version('1.1.14', 1662127984.077322)
