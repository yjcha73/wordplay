...
__all__ = [
    'OLE_YSIZE_HIMETRIC', 'Color', 'OLE_HANDLE', 'StdFont', 'Picture',
    'FONTSIZE', 'IPictureDisp', 'OLE_XSIZE_CONTAINER', 'FONTBOLD',
    'OLE_XPOS_PIXELS', 'IPicture', 'FONTUNDERSCORE', 'OLE_CANCELBOOL',
    'OLE_XPOS_HIMETRIC', 'IFontEventsDisp', 'StdPicture', 'Checked',
    'OLE_YSIZE_CONTAINER', 'VgaColor', 'OLE_YPOS_PIXELS', 'Font',
    'FontEvents', 'IFontDisp', 'OLE_ENABLEDEFAULTBOOL', 'Default',
    'FONTNAME', 'OLE_XSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS', 'Gray',
    'FONTITALIC', 'OLE_YPOS_HIMETRIC', 'OLE_YPOS_CONTAINER',
    'Monochrome', 'LoadPictureConstants', 'IFont', 'OLE_YSIZE_PIXELS',
    'OLE_XPOS_CONTAINER', 'FONTSTRIKETHROUGH', 'OLE_OPTEXCLUSIVE',
    'Unchecked', 'OLE_TRISTATE', 'OLE_COLOR'
]

_check_version('1.1.14', 1622894692.653069)
